...
public class SignInReceptionist extends JFrame implements ActionListener{
	private Start start;
	 ...
	 * @param start 
	 */
	public SignInReceptionist(Start start) {
		this.start=start;
		...
		b=new JButton("Sign in as Receptionist");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b) {
			try {
				...
				int a[]=stub.signIn(username.getText(), passwordField.getText(), 2);
				if(a[0]==1) {
					start.sir.setVisible(false);
