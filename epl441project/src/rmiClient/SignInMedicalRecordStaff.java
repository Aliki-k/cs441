...
public class SignInMedicalRecordStaff extends JFrame implements ActionListener{
	private Start start;
	 ...
	 * @param start 
	 */
	public SignInMedicalRecordStaff(Start start) {
		this.start=start;
		...
		b=new JButton("Sign in as Medical record staff");
		b.setBounds(189, 223, 226, 50);
	...
	public void actionPerformed(ActionEvent e) {
				if(e.getSource()==b) {
					try {
						...
						int a[]=stub.signIn(username.getText(), passwordField.getText(), 3);
						if(a[0]==1) {
							start.simrs.setVisible(false);
