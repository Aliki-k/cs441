...
public class SignInHealthServiceManagement extends JFrame implements ActionListener{
	...
	public SignInHealthServiceManagement(Start start) {
		...
		b=new JButton("Sign in as Health service management");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b) {
			try {
				...
				int a[]=stub.signIn(username.getText(), passwordField.getText(), 4);
				if(a[0]==1) {
					start.sihsm.setVisible(false);
					start.hsm.setVisible(true);
				}
				else {
